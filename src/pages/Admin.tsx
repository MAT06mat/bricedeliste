            ...
            <div className="max-w-5xl mx-auto space-y-6">
                <div className="flex justify-between items-center bg-brice-yellow p-4 rounded-2xl shadow-md">
                    <div className="flex flex-col">
                        <h2 className="text-2xl font-black italic text-amber-900 leading-none">
                            LES SOS À CASSER !
                        </h2>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={fetchOrders}
                            className="bg-white/40 hover:bg-white/60 px-4 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all border border-white/20"
                        >
                            {isLoading ? "..." : "🔄 Actualiser"}
                        </button>
                        <button
                            onClick={handleLogout}
                            className="bg-amber-900 text-brice-yellow px-4 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all hover:bg-black"
                        >
                            Déconnexion
                        </button>
                    </div>
                ...
                <div className="vintage-card p-4 rounded-2xl flex flex-wrap gap-4 items-center justify-between">
                    <div className="flex gap-2">
                        {(
                            ["all", "assigned", "unassigned"] as FilterStatus[]
                        ).map((s) => (
                            <button
                                key={s}
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <h3
                                                    className={`font-black text-lg text-amber-900 uppercase italic tracking-tighter ${
                                                        isCompleted
                                                            ? "line-through"
                                                            : ""
                                                    }`}
                                            ...
                                            <div className="flex items-center gap-3">
                                                {isCompleted ? (
                                                    <span className="text-[10px] font-black text-green-700 bg-green-100 px-2 py-1 rounded uppercase">
                                                        Terminé
                                                    </span>
                                                ) : (
                                                    o.assigned_to && (
                                            ...
                                            <div className="p-6 border-t-2 border-amber-900/5 bg-white/40 space-y-4 animate-in fade-in slide-in-from-top-2">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                    <div className="space-y-2 text-amber-900">
                                                        ...
                                                        <p>
                                                            ...
                                                            <span className="bg-brice-yellow/30 px-2 rounded font-black italic">
                                                                {o.sosId}
                                                            </span>
                                                        </p>
                                                    ...
                                                    <div className="bg-sand/50 p-3 rounded-xl border-2 border-dashed border-amber-200">
                                                        ...
                                                        <p className="italic text-amber-800 font-medium leading-relaxed">
                                                            "
                                                            {o.desc ||
                                                                "Pas de description, improvise un vent mémorable."}
                                                            "
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-wrap gap-2 pt-4">
                                                    ...
                                                    {!isCompleted &&
                                                        ...
                                                        auth.email ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className={`flex-1 min-w-[140px] font-black py-3 rounded-xl brice-button text-xs uppercase ${
                                                                    o.assigned_to
                                                    ...
                                                    <button
                                                        ...
                                                        className={`flex-1 min-w-[140px] font-black py-3 rounded-xl brice-button text-xs uppercase tracking-widest ${
                                                            isCompleted
